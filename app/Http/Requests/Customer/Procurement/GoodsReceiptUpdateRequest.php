...
class GoodsReceiptUpdateRequest extends BaseProcurementRequest
{
    public function rules(): array
    {
        ...
        return [
            'grn_number' => ['nullable', 'string', 'max:50', Rule::unique('goods_receipts', 'grn_number')->ignore($receiptId)],
