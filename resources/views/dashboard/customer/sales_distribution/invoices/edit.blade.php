...
<div class="container">
    <div class="d-flex justify-content-between align-items-center mb-3">
        <h3 class="mb-0">{{ __('sales_dist.invoices.edit_title') }}</h3>
    ...
    <div class="card"><div class="card-body">
        <form method="POST" action="{{ route('customer.sales-distribution.invoices.update', ['locale' => request()->route('locale'), 'invoice' => $invoice->id]) }}">
            @csrf @method('PUT')
