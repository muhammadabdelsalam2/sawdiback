...
<div class="container">
    <div class="d-flex justify-content-between align-items-center mb-3">
        <h3 class="mb-0">{{ __('procurement.requisitions.edit_title') }}</h3>
    ...
    <div class="card"><div class="card-body">
        <form method="POST" action="{{ route('customer.procurement.requisitions.update', ['locale' => request()->route('locale'), 'requisition' => $requisition->id]) }}">
            @csrf @method('PUT')
