...
@section('content')
    <div class="container py-4 livestock-page">
        ...
        <div class="card-block">
            <form method="POST" action="{{ route('superadmin.livestock.vaccines.store', ['locale' => $currentLocale]) }}">
                ...
                <div class="mt-3 d-flex gap-2">
                    ...
                    <a class="btn btn-outline-white" href="{{ route('superadmin.livestock.vaccines.index', ['locale' => $currentLocale]) }}">{{ __('livestock.actions.cancel') }}</a>
                </div>
            </form>
        </div>
    </div>
