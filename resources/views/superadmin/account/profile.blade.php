...
@section('title', __('account.profile.title') . ' | EL-Sawady')
    ...
    <div class="dashboard-body">
        <div class="chart-card">
            ...
            <form class="needs-validation" method="POST"
                action="{{ route('superadmin.profile.update', ['locale' => $activeLocale]) }}"
                    ...
                    <div class="col-lg-8">
                        ...
                        <div class="chart-card mt-3">
                            <div class="chart-card-header">
                                ...
                                <a href="{{ route('superadmin.password.show', ['locale' => $activeLocale]) }}"
